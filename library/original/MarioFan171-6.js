...
m1=ms('G8F6D4B381B4D8FB',15&(21&r/8192|0)+(r/32768|0),1,-1)*2,
...
h=min(max((((((t*(441/480))&1)-.5)*sin(t|t/(lr?2.105:2.2))/2+sin(t/2)/8)/(r%4096)*16384*cos(r%4096*PI/8192)**11)*s('  11',12),-1),1),
